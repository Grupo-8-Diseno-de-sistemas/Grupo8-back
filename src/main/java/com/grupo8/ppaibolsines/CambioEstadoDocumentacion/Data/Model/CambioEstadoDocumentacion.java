package com.grupo8.ppaibolsines.CambioEstadoDocumentacion.Data.Model;
...
public class CambioEstadoDocumentacion {
    ...
    public CambioEstadoDocumentacion(LocalDateTime fechaHorainicio, Estado estado, Empleado empleadoResponsable) {
