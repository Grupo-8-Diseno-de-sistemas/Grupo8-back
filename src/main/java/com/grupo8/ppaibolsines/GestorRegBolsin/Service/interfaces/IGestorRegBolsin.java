...
public interface IGestorRegBolsin {
    ...
    List<Bolsin> registrarRecepcionBolsin(Empleado empleadoLogueado, String numeroPrecinto, ComisionMedica cmOrigen);

    ComisionMedica buscarCMDeUsuarioLogueado(Empleado empleadoLogueado);
